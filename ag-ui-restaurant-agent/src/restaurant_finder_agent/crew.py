...
from restaurant_finder_agent.tools.custom_human_input import custom_human_input_handler


@CrewBase
class RestaurantFinderTemplateCrew:
    ...
    def crew(self) -> Crew:
        ...
        return Crew(
            ...
            verbose=True,
            # human_input_fn=custom_human_input_handler,  # Use our custom human input handler
